...
public class LancamentoBeanConsultarTest extends AbstractStartTest {
    ...
    public void testConsultarLancamentoPorNomeSemRegistro() throws Exception {
        ...
        Assert.assertEquals("Nao existem dados para consulta com o nome solicitado: '" + nome + "'", msgErro);
    }
